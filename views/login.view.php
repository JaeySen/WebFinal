    ...
    <div class="row p-4">
      ...
      <div class="col-md-6">
        ...
        <form class="" action="" method="post">
          ...
          <p class="error error-username"> <?php echo $login_errors['login_username'] ?? ''?></p>
          
          <input type="password" name="password" class="form-control" placeholder="Password" autocomplete="on">
          <p class="error error-password"> <?php echo $errors['password'] ?? ''?></p>
          <p class="error error-password"> <?php echo $login_errors['login_password'] ?? ''?></p>
